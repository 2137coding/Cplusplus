...
class borrowing{
    public :
        int* id_person = new int {0};
        int* id_book = new int {9999};
        int* x = new int {15};
...
int main(){
    std::vector<person>* a = new std::vector<person>;
    std::vector<book>* b = new std::vector<book>;
    std::vector<borrowing>* c = new std::vector<borrowing>;
